...
# A Bayesian approach to decision making in early development clinical trials : An Open Source Solution {#b-dar background-iframe="raindropp0/dist/index.html"}
...
# Early clinical trials and why `phase1b`?
...
`phase1b` was built with [Good Software Engineering Practice for R Packages](https://openstatsware.github.io/shortcourse-iscb2025/).
:::
...
- Title page Artist [Rayhan Ahmed](https://codepen.io/author-rayhan)
