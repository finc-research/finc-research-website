...
# {background-iframe="polska/dist/index.html"}#84C5B1
# A Bayesian approach to decision making in early development Oncology clinical trials {background-iframe="raindropp0/dist/index.html" style="color: #0066cc;"} -->
# that earlier green 16C47F
# whiter silver F3F2EC
```
...
# A Bayesian approach to decision making in early development Oncology clinical trials {#my-slide background-iframe="raindropp0/dist/index.html"}

[Audrey Yeo | Warszawa - Polska]{style="color: #8BDB81;"}
[19 maja]{style="color: white;"}
[CEN 2026]{style="color: #E62727;"}
...
- The updated Posterior $f( \pi | x )$ is again a $Beta$ distribution
  ...
  $$ \pi| \ x \sim Beta(\alpha + x, \ \beta + n - x)$$ where $x$ is the
  number of responders of current trials
...
- To illustrate how density of Prior changes with increased sample size
  even though mean is the same
...
- The rule = criteria is specified for Go, Stop or Evaluate (Grey zone)
...
Posterior probability of Weaker prior is
`r 100*round(weaker_prior, digits = 4)`% and of Stronger prior is
`r 100*round(stronger_prior, digits = 4)`%.
...
- Thall P F, Simon R (1994), Practical Guidelines for Phase IIB Clinical
  Trials, Biometrics, 50, 337-349

- Lee J J, Liu D D (2008), A Predictive probability design for phase II
  cancer clinical trials, 5(2), 93-106, Clinical Trials
...
- Roychoudhury, S (2022) A Bayesian Group-sequential Design for COVID-19
  Vaccine Development, DIA BSWG F2F Meeting, Joint Statistician Meeting,
  Washington DC August 9th, 2022
